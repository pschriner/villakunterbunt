...
$(document).ready(function(){
	if ($('.lightbox').length > 0) {
		...
		$(".lightbox").fancybox({
        tpl: {
          error    : '<p class="fancybox-error">Der Inhalt konnte nicht geladen werden.<br/>Bitte probieren Sie es sp�ter noch einmal.</p>',
          closeBtn : '<a title="Schliessen" class="fancybox-item fancybox-close" href="javascript:;"></a>',
          next     : '<a title="N�chstes" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>',
